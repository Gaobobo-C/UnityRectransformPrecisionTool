...
namespace GB.Tools.Editor
{
    ...
    public class RectTransformPrecisionToolEditor : EditorWindow
    {
        ...
        [MenuItem("GB Tools/Inspector/RectTransform精度控制")]
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.BeginHorizontal();
            {
                ...
                GUILayout.Label("RectTransform精度控制工具", EditorStyles.boldLabel, GUILayout.Height(30));
                GUILayout.FlexibleSpace();
            }
            ...
            {
                GUILayout.FlexibleSpace();
                GUILayout.Label("(自动限制RectTransform参数的小数点精度，确保UI布局整洁一致。)", EditorStyles.miniLabel);
                GUILayout.FlexibleSpace();
            }
            EditorGUILayout.EndHorizontal();
